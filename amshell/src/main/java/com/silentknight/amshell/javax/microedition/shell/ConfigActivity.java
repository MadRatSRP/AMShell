...
package com.silentknight.amshell.javax.microedition.shell;
...
import com.silentknight.amshell.javax.microedition.lcdui.Display;
import com.silentknight.amshell.javax.microedition.lcdui.Displayable;
import com.silentknight.amshell.javax.microedition.lcdui.Font;
import com.silentknight.amshell.javax.microedition.lcdui.MicroActivity;
import com.silentknight.amshell.javax.microedition.lcdui.XMLForm;
import com.silentknight.amshell.javax.microedition.lcdui.pointer.VirtualKeyboard;
import com.silentknight.amshell.javax.microedition.midlet.MIDlet;
import com.silentknight.amshell.javax.microedition.param.DataContainer;
import com.silentknight.amshell.javax.microedition.param.DataEditor;
import com.silentknight.amshell.javax.microedition.param.SharedPreferencesContainer;
...
public class ConfigActivity extends MicroActivity implements CommandListener, View.OnKeyListener, View.OnClickListener
{
	...
	{
		DataContainer params = new SharedPreferencesContainer("RunConfiguration", Context.MODE_WORLD_READABLE);
		...
		try
		{
			...
			VirtualKeyboard.LayoutListener listener = new VirtualKeyboard.LayoutListener()
			{
				public void layoutChanged(VirtualKeyboard vk)
				{
					try
					{
						DataOutputStream dos = new DataOutputStream(ContextHolder.getContext().openFileOutput("VirtualKeyboardLayout", Context.MODE_WORLD_READABLE));
						vk.writeLayout(dos);
						dos.close();
					}
					catch(IOException ioe)
