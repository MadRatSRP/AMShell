...
/**
 * РџСЂРёРІСЏР·РєР° РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРєРѕРІ.
 * 
 * <pre>
 * РЎСѓС‚СЊ:
 * 
 ...
 * </pre>
 * 
 * Р”Р»СЏ СѓРґРѕР±СЃС‚РІР° Р·РґРµСЃСЊ РѕРїСЂРµРґРµР»РµРЅС‹ РґРІР° РЅР°Р±РѕСЂР° РєРѕРЅСЃС‚Р°РЅС‚ РїРѕ СЃС‚РѕСЂРѕРЅР°Рј СЃРІРµС‚Р°.
 * РљРѕРЅСЃС‚Р°РЅС‚С‹ РЅР° EXT_ РѕРїСЂРµРґРµР»СЏСЋС‚ РїСЂРёРІСЏР·РєСѓ СЃРЅР°СЂСѓР¶Рё РґСЂСѓРіРѕРіРѕ РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРєР°,
 * РєРѕРЅСЃС‚Р°РЅС‚С‹ РЅР° INT_ РѕРїСЂРµРґРµР»СЏСЋС‚ РїСЂРёРІСЏР·РєСѓ РІРЅСѓС‚СЂРё РґСЂСѓРіРѕРіРѕ РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРєР°.
 */
public class RectSnap
{
	...
	/**
	 * РћРїСЂРµРґРµР»РёС‚СЊ СЂРµР¶РёРј РїСЂРёРІСЏР·РєРё РґРІСѓС… РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРєРѕРІ (РµСЃР»Рё РµСЃС‚СЊ).
	 * Р’РµСЂСЃРёСЏ РґР»СЏ Rect.
	 * 
	 * @param target С‡С‚Рѕ РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param origin РєСѓРґР° РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param radius РЅР° РєР°РєРѕРј СЂР°СЃСЃС‚РѕСЏРЅРёРё РЅР°С‡РёРЅР°РµС‚ РґРµР№СЃС‚РІРѕРІР°С‚СЊ РїСЂРёРІСЏР·РєР°
	 * @param mask РјР°СЃРєР° СЂР°Р·СЂРµС€РµРЅРЅС‹С… РїСЂРёРІСЏР·РѕРє
	 * @param biaxial РµСЃР»Рё true, С‚Рѕ РїСЂРёРІСЏР·РєР° Р±СѓРґРµС‚ Р»РёР±Рѕ РїРѕ РѕР±РѕРёРј РѕСЃСЏРј, Р»РёР±Рѕ РµРµ РІРѕРѕР±С‰Рµ РЅРµ Р±СѓРґРµС‚
	 * @return СЂРµР¶РёРј РїСЂРёРІСЏР·РєРё, РёР»Рё NO_SNAP
	 */
	...
	/**
	 * РћРїСЂРµРґРµР»РёС‚СЊ РЅР°РёР»СѓС‡С€СѓСЋ РїСЂРёРІСЏР·РєСѓ РґРІСѓС… РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРєРѕРІ (СЃСѓС‰РµСЃС‚РІСѓРµС‚ РІСЃРµРіРґР°),
	 * Рё РѕРїС†РёРѕРЅР°Р»СЊРЅРѕ РІРµСЂРЅСѓС‚СЊ СЃРјРµС‰РµРЅРёРµ РѕС‚ СЌС‚РѕР№ РїСЂРёРІСЏР·РєРё.
	 * Р’РµСЂСЃРёСЏ РґР»СЏ Rect Рё Point.
	 * 
	 * @param target С‡С‚Рѕ РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param origin РєСѓРґР° РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param offset С‚РѕС‡РєР°, РІ РєРѕС‚РѕСЂСѓСЋ Р±СѓРґРµС‚ Р·Р°РїРёСЃР°РЅРѕ СЃРјРµС‰РµРЅРёРµ РѕС‚ РїСЂРёРІСЏР·РєРё (РёР»Рё null)
	 * @return СЂРµР¶РёРј РїСЂРёРІСЏР·РєРё
	 */
	 ...
	 * РћРїСЂРµРґРµР»РёС‚СЊ РЅР°РёР»СѓС‡С€СѓСЋ РїСЂРёРІСЏР·РєСѓ РґРІСѓС… РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРєРѕРІ (СЃСѓС‰РµСЃС‚РІСѓРµС‚ РІСЃРµРіРґР°),
	 * Рё РѕРїС†РёРѕРЅР°Р»СЊРЅРѕ РІРµСЂРЅСѓС‚СЊ СЃРјРµС‰РµРЅРёРµ РѕС‚ СЌС‚РѕР№ РїСЂРёРІСЏР·РєРё.
	 * Р’РµСЂСЃРёСЏ РґР»СЏ RectF Рё PointF.
	 * 
	 * @param target С‡С‚Рѕ РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param origin РєСѓРґР° РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param offset С‚РѕС‡РєР°, РІ РєРѕС‚РѕСЂСѓСЋ Р±СѓРґРµС‚ Р·Р°РїРёСЃР°РЅРѕ СЃРјРµС‰РµРЅРёРµ РѕС‚ РїСЂРёРІСЏР·РєРё (РёР»Рё null)
	...
	/**
	 * РџСЂРёРІСЏР·Р°С‚СЊ РѕРґРёРЅ РїСЂСЏРјРѕСѓРіРѕР»СЊРЅРёРє Рє РґСЂСѓРіРѕРјСѓ,
	 * РѕРїС†РёРѕРЅР°Р»СЊРЅРѕ СЃРјРµСЃС‚РёРІ РµРіРѕ РЅР° РЅРµРєРѕС‚РѕСЂРѕРµ СЂР°СЃСЃС‚РѕСЏРЅРёРµ РѕС‚ РїСЂРёРІСЏР·РєРё.
	 * Р’РµСЂСЃРёСЏ РґР»СЏ Rect Рё Point.
	 * 
	 * @param target С‡С‚Рѕ РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param origin РєСѓРґР° РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param mode РєР°Рє РїСЂРёРІСЏР·С‹РІР°С‚СЊ
	 * @param offset С‚РѕС‡РєР°, РІ РєРѕС‚РѕСЂРѕР№ СЃРѕРґРµСЂР¶РёС‚СЃСЏ СЃРјРµС‰РµРЅРёРµ РѕС‚ РїСЂРёРІСЏР·РєРё (РёР»Рё null)
	 */
