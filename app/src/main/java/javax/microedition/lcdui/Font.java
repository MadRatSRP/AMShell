...
public class Font
{
	...
	public Font(Typeface face, int style, float size, boolean underline)
	{
		...
		paint.setTextSize(size);                                             // СЃРЅР°С‡Р°Р»Р° РїСЂРѕСЃС‚Рѕ Р·Р°РґР°РµРј СЂР°Р·РјРµСЂ (РЅРµ РІР°Р¶РЅРѕ РІ С‡РµРј РѕРЅ Р·РґРµСЃСЊ СЃС‚Р°РІРёС‚СЃСЏ)
		paint.setTextSize(size * size / (paint.descent() - paint.ascent())); // Р° С‚РµРїРµСЂСЊ СЃС‚Р°РІРёРј СЂР°Р·РјРµСЂ С‚РѕС‡РЅРѕ СЂР°РІРЅС‹Р№ Р·Р°РґР°РЅРЅРѕРјСѓ (РІ РїРёРєСЃРµР»СЏС…)
	}
